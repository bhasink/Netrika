                                    ...
                                    @foreach($get_category_data as $key=>$get_category_data_d)
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$get_category_data_d->name}}</td>
                                                                ...
                                                                <td>{{$get_category_data_d->service_category->name}}</td>
                                            ...
                                            <td>
                                            <a href="/admin/service/list-style/edit/{{$get_category_data_d->id}}/{{$get_category_data_d->service_category_id}}" class="btn btn-success">Add / Update</a>
                                            </td>
