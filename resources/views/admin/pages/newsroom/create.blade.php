...
@section('content')
    ...
    <div class="col-md-10 col-sm-12 ">
        <div class="x_panel">
            <div class="x_title">
                <h2>Newsroom <small>Create</small></h2>
            ...
            <div class="x_content">
                ...
                <br />
                <form action="/admin/newsroom/create" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-10 col-sm-10 ">
                            <input type="text" id="article_link" name="article_link"  class="form-control "  @if ($errors->has('article_link')) style="border: 1px solid red"  @endif>
