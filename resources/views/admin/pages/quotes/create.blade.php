...
@section('content')
    ...
    <div class="col-md-10 col-sm-12 ">
        <div class="x_panel">
            <div class="x_title">
                <h2>Quotes <small>Create</small></h2>
            ...
            <div class="x_content">
                ...
                <br />
                <form action="/admin/quotes/create" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-10 col-sm-10 ">
                            <input type="text" id="name" name="name"  class="form-control "  @if ($errors->has('name')) style="border: 1px solid red"  @endif>
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-10 col-sm-10 ">
                            <input type="text" id="designation" name="designation"  class="form-control "  @if ($errors->has('designation')) style="border: 1px solid red"  @endif>
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-10 col-sm-10 ">
                            <input type="text" id="quotes" name="quotes" class="form-control "  @if ($errors->has('quotes')) style="border: 1px solid red"  @endif>
