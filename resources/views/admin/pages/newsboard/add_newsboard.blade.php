...
@section('content')
    ...
    <div class="col-md-8 col-sm-12 ">
        <div class="x_panel">
            <div class="x_title">
                <h2>Newsboard <small>Create</small></h2>
            ...
            <div class="x_content">
                ...
                <br />
                <form action="{{ route('home_newsboard.save') }}" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" enctype="multipart/form-data">
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                            <input id="title" class="form-control" type="text" name="title"  @if ($errors->has('title')) style="border: 1px solid red"  @endif value="{{old('title')}}">
                        </div>
                    </div>
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                            <input id="event_date" class="form-control" type="date" name="event_date"  @if ($errors->has('event_date')) style="border: 1px solid red"  @endif value="{{old('event_date')}}">
                        </div>
                    </div>
