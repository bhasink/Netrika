...
@section('content')
    ...
    <style>
        .team-sd {
            padding: 4.3em 2.5em 0em 2.5em;
        }
    </style>
    {{--<div class="team-banner video-page">--}}
        {{--<p class="scrollanimation animated bounceIn adl-2"><span style="color: rgb(253, 228, 40);">Video</span> Gallery</p>--}}
    {{--</div>--}}
    <div class="page_title">
        <div class="container-fluid">
            <div class="breadcrumbs">
                ...
                <span><a href="#"><span property="name">Video Gallery</span></a></span>
            </div>
        </div>
    </div>
    <section class="videogallery-page main-v-page" id="videogallery-page" style="background: #ffffff;">
        <div class="container-fluid">
            <div class="row" style="">
                                    ...
                                    @foreach($data['get_video_gallery'] as $key=>$get_video_gallery)
                                        ...
                                        <div class="col-md-4 video-blk">
                                            ...
                                            <a data-fancybox="gallery" href="https://www.youtube.com/watch?v={{$get_video_gallery->video_link}}">
                                                ...
                                                {{--<img style="  background: url(http://lorempixel.com/300/300);--}}
{{--}" src="http://img.youtube.com/vi/{{$get_video_gallery->video_link}}/hqdefault.jpg">--}}
                                                {{--<div class="overlay-pattern"></div>--}}
                                            </a>

                                            <p>{{$get_video_gallery->title}}</p>
                                            </div>
                                        </div>
                            ...
                            <div style="" class="col-md-12 row button-box-text">
                                {{ $data['get_video_gallery']->appends(['cat' => 999999,'all' => 1])->render() }}
                            </div>
                        </div>
                    </div>
                </div>
...
@section('script')
    ...
    <script>
		...
		<script>
document.getElementsByTagName('meta')["keywords"].content = "Video Gallery";
document.getElementsByTagName('meta')["description"].content = "Netrika Video Gallery about news, interviews and insights.";
document.title = "Video Gallery | Netrika";
