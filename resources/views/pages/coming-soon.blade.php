...
@section('content')
    ...
    <style>
        ...
        .upcoming-page {
            height: 500px;
            background: linear-gradient(0deg, rgba(0, 0, 0, 0.3), rgba(0, 0, 0, 0.3)), url(/img/coming-soon-1480x500.jpg);
        ...
        @media screen and (max-width: 600px) {
            ...
            .upcoming-page {
                height: 500px;
                background: linear-gradient(0deg, rgba(0, 0, 0, 0.3), rgba(0, 0, 0, 0.3)), url(/img/coming-soon-600x500.jpg) !important;
